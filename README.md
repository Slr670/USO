...
- [ระบบคำนวณวาระเจ้าหน้าที่รัฐ กรมการปกครอง (DOPA Tenure Tracker)](#ระบบคำนวณวาระเจ้าหน้าที่รัฐ-กรมการปกครอง-dopa-tenure-tracker)
...
2. **DOPA Tenure Tracking Widget (Full-Width):** เครื่องมือคำนวณระยะเวลาดำรงตำแหน่งของเจ้าหน้าที่ฝ่ายปกครองสำหรับ 181 สถานี USO แสดงผลแบบเต็มความกว้าง (Full Width) คำนวณวัน/เดือน/ปีคงเหลือ และแถบความคืบหน้า (Progress Bar) แบบเรียลไทม์
...
6. **6. Track DOPA Officials' Tenure:** ติดตามและคำนวณวาระเจ้าหน้าที่รัฐ กรมการปกครอง (Department of Provincial Administration) — คำนวณวันสิ้นสุดวาระและสถานะคงเหลือของสถานี USO 181 แห่ง พร้อมลิงก์ตรง ([เข้าสู่ระบบวาระ DOPA](https://wara5year.vercel.app/))
...
## ระบบคำนวณวาระเจ้าหน้าที่รัฐ กรมการปกครอง (DOPA Tenure Tracker)
โมดูลที่ 6 มาพร้อมเครื่องมือคำนวณวาระการดำรงตำแหน่งของเจ้าหน้าที่ฝ่ายปกครองที่ดูแลสถานีเครือข่าย USO 181 แห่ง:
- **รูปแบบการแสดงผลแบบเต็มความกว้าง (Full Width):** ปรับขนาดให้เต็มความกว้างของคอนเทนเนอร์การ์ด พร้อมการจัดเรียง Responsive Input (วันเริ่มต้นวาระ และระยะเวลาตามวาระ)
- **การคำนวณวันสิ้นสุดวาระ:** คำนวณวันสิ้นสุดที่แม่นยำ พร้อมนับถอยหลังจำนวนปี เดือน วัน
- **แถบความคืบหน้าแบบ Real-time:** แสดงสถานะร้อยละ (% Completion) และเปลี่ยนสีสถานะตามระดับความเร่งด่วน (ปกติ, ใกล้ครบวาระ, สิ้นสุดวาระ)
...
- **รองรับภาษาไทยครบทุกส่วน:** รวมทั้งชื่อโมดูล รายละเอียด ป้ายสถานะ ข้อความช่วยเหลือ และเครื่องมือคำนวณ
...
```bash
./mvnw clean package
java -jar target/shf-dashboard-2.4.3.jar
```
